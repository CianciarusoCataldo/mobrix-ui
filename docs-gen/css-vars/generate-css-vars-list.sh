...
for cssvar in $(cat docs-gen/components/global-css-vars.json | jq 'keys_unsorted[]'); do
    ...
    sed -i "s/FALLBACK/FALLBACK_$COUNT/g" "$OUTPUT_FILE_PATH"/global/tmp_row.md
    sed -i "s/DEFAULT/"DEFAULT_$COUNT"/g" "$OUTPUT_FILE_PATH"/global/tmp_row.md
    ...
    echo -n "\n\n" >>"$OUTPUT_FILE_PATH"/global/list.md
    cat docs-gen/css-vars/templates/table-header-mini.md >>"$OUTPUT_FILE_PATH"/global/tmp_row_mini.md
    cat docs-gen/css-vars/templates/table-row-mini.md >>"$OUTPUT_FILE_PATH"/global/tmp_row_mini.md
    sed -i "s/FALLBACK/FALLBACK_$COUNT/" "$OUTPUT_FILE_PATH"/global/tmp_row_mini.md
    sed -i "s/DEFAULT/"DEFAULT_$COUNT"/" "$OUTPUT_FILE_PATH"/global/tmp_row_mini.md
...
for type in $(
    ...
    for actualComponent in $(
        ...
        cat docs-gen/css-vars/templates/table-header.md >>"$componentPath"/table.md
        cat docs-gen/css-vars/templates/table-header.md >>"$componentPath"/table-external.md
        cat docs-gen/css-vars/templates/table-header.md >>"$componentPath"/table-global.md
        cat docs-gen/css-vars/templates/table-base.md >>"$componentPath"/index.md
        ...
        for cssvar in $(cat docs-gen/components/"$type"/"$component"/css-vars.json | jq 'keys_unsorted[]'); do
            ...
            sed -i "s/FALLBACK/FALLBACK_$COUNTER/g" "$componentPath"/tmp_row.md
            sed -i "s/DEFAULT/"DEFAULT_$COUNTER"/g" "$componentPath"/tmp_row.md
            sed -i "s/PROP_NAME/PROP_NAME_EXTERNAL_$COUNTER/g" "$componentPath"/tmp_row_external.md
            sed -i "s/FALLBACK/FALLBACK_EXTERNAL_$COUNTER/g" "$componentPath"/tmp_row_external.md
            sed -i "s/DEFAULT/"DEFAULT_EXTERNAL_$COUNTER"/g" "$componentPath"/tmp_row_external.md
        ...
        node "docs-gen/css-vars/parse-component.js"
