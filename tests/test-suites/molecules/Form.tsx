...
const formTest = () => {
  describe("Form", () => {
    test("Rendering test", () => {
      ...
      wrapper
        .find('input[data-id="form_field_testField3"]')
    ...
    test("Submit test", () => {
      ...
      wrapper
        .find('input[data-id="form_field_testField3"]')
        .simulate("change", "new test text");
      wrapper.find('div[data-id="form_field_testField1"]').simulate("click");

      wrapper.find('[data-id="form_submit_button"]').simulate("click");
