  ...
  <BasicIcon props={iprops}>
    {(props) => (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        version="1.0"
        viewBox="0 0 1171 1280"
        data-mbx-img="tick"
        {...props}
      >
        <path d="M1155.5 10.6C1026.7 99.4 896.4 218.2 761 370 613.5 535.6 458.4 748.3 329.5 961.8c-7.2 11.9-11.5 18-12.3 17.7-.8-.3-71.6-47.4-157.5-104.8S2.9 770 2.1 769.5c-1.1-.6-1-.2.2 1.6 9.8 14 370.4 507.8 370.9 507.9.3 0 3.4-6.6 6.8-14.8 122.5-291.8 242.2-523.4 383.8-742.7 114.8-177.7 248.1-349.7 389.9-502.8C1162.8 9 1170 1 1169.8 1c-.2 0-6.7 4.3-14.3 9.6z" />
      </svg>
    )}
  </BasicIcon>
);
