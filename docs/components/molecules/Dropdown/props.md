...
actual selected element (as index). If not set, default value will be used.<br><br>
...
If `true`, hide the arrow icon near selected element<br><br>
...
Callback triggered when selecting new element from dropdown<br><br>
